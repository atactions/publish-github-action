...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            yield exec.exec('git', ['checkout', '-b', branchName], { ignoreReturnCode: true });
            ...
            yield exec.exec('git', ['push', 'origin', branchName]);
            yield exec.exec('git', ['push', 'origin', ':refs/tags/' + version], { ignoreReturnCode: true });
            yield exec.exec('git', ['tag', '-fa', version, '-m', version]);
            yield exec.exec('git', ['push', 'origin', ':refs/tags/' + minorVersion], { ignoreReturnCode: true });
            yield exec.exec('git', ['tag', '-f', minorVersion]);
            yield exec.exec('git', ['push', 'origin', ':refs/tags/' + majorVersion], { ignoreReturnCode: true });
